...
BATCH_LOCKED = """<b>🔒 ʙᴀᴛᴄʜ ᴍᴏᴅᴇ — ᴀᴅᴍɪɴ ᴏɴʟʏ</b>
{line}
ᴇᴋ sᴀᴀᴛʜ ᴍᴜʟᴛɪᴘʟᴇ ғɪʟᴇs ᴋᴀ <b>ᴇᴋ ʟɪɴᴋ</b> sɪʀғ ᴀᴅᴍɪɴ ʙᴀɴᴀ sᴀᴋᴛᴀ ʜᴀɪ.

ᴛᴜᴍ <code>/single</code> ᴜsᴇ ᴋᴀʀᴏ — ʜᴀʀ ғɪʟᴇ ᴋᴀ <b>ᴀʟᴀɢ ʟɪɴᴋ</b> ᴛᴜʀᴀɴᴛ ᴍɪʟᴇɢᴀ.
(ʏᴀ sɪᴅʜᴇ ғɪʟᴇ ʙʜᴇᴊ ᴅᴏ, ʟɪɴᴋ ᴀᴀ ᴊᴀᴇɢᴀ)
{line}
<i>ʙᴀᴛᴄʜ ᴄʜᴀʜɪʏᴇ? ᴀᴅᴍɪɴ sᴇ ᴋᴀʜᴏ ᴛᴜᴍʜᴇ ᴀᴅᴅ ᴋᴀʀᴇ.</i>"""
...
{line}
<b>ᴀᴘɴɪ ғɪʟᴇ ᴋᴀ ʟɪɴᴋ ʙᴀɴᴀɴᴀ ʜᴀɪ?</b>
ʙᴀs ғɪʟᴇ ʙʜᴇᴊ ᴅᴏ — ʟɪɴᴋ ᴛᴜʀᴀɴᴛ ᴍɪʟ ᴊᴀᴇɢᴀ ✓
<code>/single</code> — ʜᴀʀ ғɪʟᴇ ᴋᴀ ᴀʟᴀɢ ʟɪɴᴋ
{line}
<i>ᴍᴜʟᴛɪᴘʟᴇ ғɪʟᴇs ᴋᴀ ᴇᴋ ʟɪɴᴋ (ʙᴀᴛᴄʜ) sɪʀғ ᴀᴅᴍɪɴ ᴋᴇ ʟɪʏᴇ ʜᴀɪ.</i>"""
